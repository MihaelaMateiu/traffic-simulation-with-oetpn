...
public class Controller2 {
    ...
    public static void main(String[] args) {
        ...
        p10.SetName("OP4");
        p10.Value = new TransferOperation("localhost", "1080", "TL4");
        pn.PlaceList.add(p10);

        DataTransfer p11 = new DataTransfer();
        p11.SetName("OP5");
        p11.Value = new TransferOperation("localhost", "1080", "TL5");
        pn.PlaceList.add(p11);

        DataTransfer p12 = new DataTransfer();
        p12.SetName("OP6");
        p12.Value = new TransferOperation("localhost", "1080", "TL6");
        pn.PlaceList.add(p12);

        DataTransfer p13 = new DataTransfer();
        p13.SetName("OP7");
        p13.Value = new TransferOperation("localhost", "1080", "TL7");
        pn.PlaceList.add(p13);

        // Input Places - Full Signal
        ...
        // Counters - Lane Numbers
        DataFloat counter4 = new DataFloat();
        counter4.SetName("counter4");
        counter4.SetValue(3.0f);
        pn.PlaceList.add(counter4);

        DataFloat counter5 = new DataFloat();
        counter5.SetName("counter5");
        counter5.SetValue(2.0f);
        pn.PlaceList.add(counter5);

        DataFloat counter6 = new DataFloat();
        counter6.SetName("counter6");
        counter6.SetValue(2.0f);
        pn.PlaceList.add(counter6);

        DataFloat counter7 = new DataFloat();
        counter7.SetName("counter7");
        counter7.SetValue(3.0f);
        pn.PlaceList.add(counter7);
        ...
        t2.InputPlaceName.add("counter4");
        ...
        grdT2.Activations.add(new Activation(t2, "counter4", TransitionOperation.Move, "counter4"));
        ...
        Condition T2Ct4 = new Condition(t2, "counter4", TransitionCondition.MoreThan, "zero");
        ...
        grdT22.Activations.add(new Activation(t2, list1, TransitionOperation.Sub, "counter4"));

        t2.GuardMappingList.add(grdT22);

        Condition T2Ct6 = new Condition(t2, "counter4", TransitionCondition.Equal, "zero");
        ...
        grdT23.Activations.add(new Activation(t2, "three", TransitionOperation.Move, "counter4"));
        grdT23.Activations.add(new Activation(t2, "yellow", TransitionOperation.SendOverNetwork, "OP4"));
        ...
        t4.InputPlaceName.add("counter5");
        ...
        grdT41.Activations.add(new Activation(t4, "yellow", TransitionOperation.SendOverNetwork, "OP5"));
        grdT41.Activations.add(new Activation(t4, "counter5", TransitionOperation.Move, "counter5"));

        t4.GuardMappingList.add(grdT41);

        Condition T4Ct3 = new Condition(t4, "in2", TransitionCondition.NotNull);
        Condition T4Ct4 = new Condition(t4, "counter5", TransitionCondition.MoreThan, "zero");
        ...
        list2.add("counter5");
        list2.add("one");
        grdT42.Activations.add(new Activation(t4, list2, TransitionOperation.Sub, "counter5"));

        t4.GuardMappingList.add(grdT42);

        Condition T4Ct6 = new Condition(t4, "counter5", TransitionCondition.Equal, "zero");
        ...
        grdT43.Activations.add(new Activation(t4, "three", TransitionOperation.Move, "counter5"));
        grdT43.Activations.add(new Activation(t4, "yellow", TransitionOperation.SendOverNetwork, "OP5"));
        ...
        t6.InputPlaceName.add("counter6");
        ...
        grdT61.Activations.add(new Activation(t6, "yellow", TransitionOperation.SendOverNetwork, "OP6"));
        grdT61.Activations.add(new Activation(t6, "counter6", TransitionOperation.Move, "counter6"));

        t6.GuardMappingList.add(grdT61);

        Condition T6Ct3 = new Condition(t6, "in3", TransitionCondition.NotNull);
        Condition T6Ct4 = new Condition(t6, "counter6", TransitionCondition.MoreThan, "zero");
        ...
        grdT62.Activations.add(new Activation(t6, list3, TransitionOperation.Sub, "counter6"));

        t6.GuardMappingList.add(grdT62);

        Condition T6Ct6 = new Condition(t6, "counter6", TransitionCondition.Equal, "zero");
        ...
        grdT63.Activations.add(new Activation(t6, "three", TransitionOperation.Move, "counter6"));
        grdT63.Activations.add(new Activation(t6, "yellow", TransitionOperation.SendOverNetwork, "OP6"));
        ...
        t8.InputPlaceName.add("counter7");
        t8.InputPlaceName.add("r1r2r3g4");


        Condition T8Ct1 = new Condition(t4, "in4", TransitionCondition.IsNull);
        ...
        grdT81.Activations.add(new Activation(t8, "yellow", TransitionOperation.SendOverNetwork, "OP7"));
        grdT81.Activations.add(new Activation(t8, "counter7", TransitionOperation.Move, "counter7"));

        t8.GuardMappingList.add(grdT81);

        Condition T8Ct3 = new Condition(t8, "in4", TransitionCondition.NotNull);
        Condition T8Ct4 = new Condition(t8, "counter7", TransitionCondition.MoreThan, "zero");
        ...
        grdT82.Activations.add(new Activation(t8, list4, TransitionOperation.Sub, "counter7"));

        t8.GuardMappingList.add(grdT82);

        Condition T8Ct6 = new Condition(t8, "counter7", TransitionCondition.Equal, "zero");
        ...
        grdT83.Activations.add(new Activation(t8, "three", TransitionOperation.Move, "counter7"));
        grdT83.Activations.add(new Activation(t8, "yellow", TransitionOperation.SendOverNetwork, "OP7"));
